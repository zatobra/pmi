import {
  ...
  @Component({
    selector: "section-sixteen-view",
    templateUrl: "./section-sixteen-view.component.html",
    styleUrls: ["./section-sixteen-view.component.scss"],
  })
  export class SectionSixteenViewComponent implements OnInit {
    @Input("data") data;
