...
@Component({
  selector: "section-seventeen-view",
  templateUrl: "./section-seventeen-view.component.html",
  styleUrls: ["./section-seventeen-view.component.scss"],
})
export class SectionSeventeenViewComponent implements OnInit {
  @Input("data") data;
  ...
  ngOnInit() {
    ...
    if(this.projectType.toLowerCase() == 'pmi_audit'){
      this.unit_availableORavailable_sku_Label = "Front Stock";
      this.empty_facing_Label = "Back Stock";
