...
@Component({
  selector: "app-doughnet-chart-widget",
  templateUrl: "./doughnet.chart.widget.component.html",
  styleUrls: ["./doughnet.chart.widget.component.scss"],
  encapsulation: ViewEncapsulation.Emulated,
})
export class DoughnetChartWidgetComponent implements OnInit {
...
// }
  ...
  setChartData() {
    ...
    // ];
    this.doughnutChartData2 = [[this.value, 100 - this.value]];
