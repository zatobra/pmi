...
@Component({
  selector: "app-captured-shops",
  templateUrl: "./captured-shops.component.html",
  styleUrls: ["./captured-shops.component.scss"],
})
export class CapturedShopsComponent implements OnInit {
  @ViewChild("childModal") childModal: ModalDirective;
  title = "Captured Shops";
