...
@Component({
  selector: "upload-samsung-retailer-data",
  templateUrl: "./upload-samsung-retailer-data.component.html",
  styleUrls: ["./upload-samsung-retailer-data.component.scss"],
  providers: [
...
export class UploadSamsungRetailerDataComponent implements OnInit {
...
monthList =[
  ...
  uploadData(post) {
    ...
    if (
      ...
      this.loadingData = true;
      this.httpService.uploadSamsungRetailerData(formData).subscribe((data) => {
        if (data) {
          debugger;
          this.response = data;
