...
@Component({
  selector: "upload-tgt-file",
  templateUrl: "./upload-tgt-file-component.html",
  styleUrls: ["./upload-tgt-file-component.scss"],
  providers: [
...
export class UploadTgtFileComponent implements OnInit {
...
|| !moment(this.year.value).format("YYYY")) {
      ...
      this.loadingData = true;
      this.httpService.uploadTgtFile(formData).subscribe((data) => {
        if (data) {
          debugger;
          this.response = data;
