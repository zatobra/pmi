...
@Component({
  selector: "samsung-claim-management-travelling",
  templateUrl: "./samsung-claims-management-travelling-component.html",
  styleUrls: ["./samsung-claims-management-travelling-component.scss"],
})
export class SamsungClaimManagementTravellingComponent implements OnInit, OnChanges  {
