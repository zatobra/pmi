...
@Component({
  selector: "samsung-sales-achievement-report",
  templateUrl: "./samsung-sales-achievement-report.component.html",
  styleUrls: ["./samsung-sales-achievement-report.component.scss"],
  providers: [
...
export class SamsungSalesAchievementReportComponent implements OnInit {
...
monthList =[
  ...
  getSamsungSalesAchievementReport() {
    // if (this.endDate >= this.startDate) {
      ...
      const url = "samsungSalesAchievementReportController";
